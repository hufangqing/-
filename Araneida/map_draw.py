...
class Draw_map():
    ...
    def to_map_china(self,area, variate,update_time):
        pieces = [{"max": 9999999, "min": 10001, "label": ">100000", "color": "#8A0808"},
                  {"max": 999999, "min": 10000, "label": "10000-99999", "color": "#B40404"},
                  {"max": 99999, "min": 1000, "label": "1000-9999", "color": "#DF0101"},
                  {"max": 9999, "min": 100, "label": "100-999", "color": "#F78181"},
                  {"max": 999, "min": 10, "label": "10-99", "color": "#F5A9A9"},
                  {"max": 99, "min": 1, "label": "1-9", "color": "#FFFFFF"},
                  {"max": 9, "min": 0, "label": "0", "color": "#CCFFFF"},
                  ]
